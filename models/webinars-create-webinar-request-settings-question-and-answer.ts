 ...
 * @export
 * @interface WebinarsCreateWebinarRequestSettingsQuestionAndAnswer
 */
export interface WebinarsCreateWebinarRequestSettingsQuestionAndAnswer {
    /**
     * * `true`: Allow participants to submit questions.  * `false`: Do not allow submit questions.
     * @type {boolean}
     * @memberof WebinarsCreateWebinarRequestSettingsQuestionAndAnswer
     */
     ...
     * @memberof WebinarsCreateWebinarRequestSettingsQuestionAndAnswer
     */
    'answer_questions'?: WebinarsCreateWebinarRequestSettingsQuestionAndAnswerAnswerQuestionsEnum;
    /**
...
type WebinarsCreateWebinarRequestSettingsQuestionAndAnswerAnswerQuestionsEnum = 'only' | 'all'
