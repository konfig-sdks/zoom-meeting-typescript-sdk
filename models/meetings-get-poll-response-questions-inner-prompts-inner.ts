 ...
 * 
 * @export
 * @interface MeetingsGetPollResponseQuestionsInnerPromptsInner
 */
export interface MeetingsGetPollResponseQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof MeetingsGetPollResponseQuestionsInnerPromptsInner
     */
