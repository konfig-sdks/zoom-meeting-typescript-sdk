 ...
 * 
 * @export
 * @interface MeetingsCreatePollResponseQuestionsInnerPromptsInner
 */
export interface MeetingsCreatePollResponseQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof MeetingsCreatePollResponseQuestionsInnerPromptsInner
     */
