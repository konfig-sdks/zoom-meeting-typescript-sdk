 ...
 * 
 * @export
 * @interface WebinarsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner
 */
export interface WebinarsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner {
    /**
     * The interpreter\'s email address.
     * @type {string}
     * @memberof WebinarsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner
     */
    'email'?: string;
    /**
