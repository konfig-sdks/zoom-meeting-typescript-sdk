 ...
 * 
 * @export
 * @interface MeetingsGetDetailsResponseTrackingFieldsInner
 */
export interface MeetingsGetDetailsResponseTrackingFieldsInner {
    /**
     * The tracking field\'s label.
     * @type {string}
     * @memberof MeetingsGetDetailsResponseTrackingFieldsInner
     */
    'field'?: string;
    /**
