 ...
 * 
 * @export
 * @interface WebinarsCreateWebinarRequestSettingsLanguageInterpretationInterpretersInner
 */
export interface WebinarsCreateWebinarRequestSettingsLanguageInterpretationInterpretersInner {
    /**
     * The interpreter\'s email address.
     * @type {string}
     * @memberof WebinarsCreateWebinarRequestSettingsLanguageInterpretationInterpretersInner
     */
    'email'?: string;
    /**
