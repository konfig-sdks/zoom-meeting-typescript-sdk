 ...
 * 
 * @export
 * @interface MeetingsCreateMeetingRequestSettingsLanguageInterpretationInterpretersInner
 */
export interface MeetingsCreateMeetingRequestSettingsLanguageInterpretationInterpretersInner {
    /**
     * The interpreter\'s email address.
     * @type {string}
     * @memberof MeetingsCreateMeetingRequestSettingsLanguageInterpretationInterpretersInner
     */
    'email'?: string;
    /**
