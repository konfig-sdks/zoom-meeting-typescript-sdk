 ...
 * @export
 * @interface MeetingsCreateMeetingResponseRecurrence
 */
export interface MeetingsCreateMeetingResponseRecurrence {
    /**
     ...
     * @type {string}
     * @memberof MeetingsCreateMeetingResponseRecurrence
     */
     ...
     * @memberof MeetingsCreateMeetingResponseRecurrence
     */
    'monthly_week'?: MeetingsCreateMeetingResponseRecurrenceMonthlyWeekEnum;
    /**
     ...
     * @memberof MeetingsCreateMeetingResponseRecurrence
     */
    'monthly_week_day'?: MeetingsCreateMeetingResponseRecurrenceMonthlyWeekDayEnum;
    /**
     ...
     * @memberof MeetingsCreateMeetingResponseRecurrence
     */
    'type': MeetingsCreateMeetingResponseRecurrenceTypeEnum;
    /**
     ...
     * @memberof MeetingsCreateMeetingResponseRecurrence
     */
    'weekly_days'?: MeetingsCreateMeetingResponseRecurrenceWeeklyDaysEnum;
}

type MeetingsCreateMeetingResponseRecurrenceMonthlyWeekEnum = -1 | 1 | 2 | 3 | 4
type MeetingsCreateMeetingResponseRecurrenceMonthlyWeekDayEnum = 1 | 2 | 3 | 4 | 5 | 6 | 7
type MeetingsCreateMeetingResponseRecurrenceTypeEnum = 1 | 2 | 3
type MeetingsCreateMeetingResponseRecurrenceWeeklyDaysEnum = '1' | '2' | '3' | '4' | '5' | '6' | '7'
