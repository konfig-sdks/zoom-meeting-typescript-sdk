 ...
 * @export
 * @interface MeetingsCreateMeetingRequestSettingsContinuousMeetingChat
 */
export interface MeetingsCreateMeetingRequestSettingsContinuousMeetingChat {
    /**
     * Whether to enable the **Enable continuous meeting chat** setting.
     * @type {boolean}
     * @memberof MeetingsCreateMeetingRequestSettingsContinuousMeetingChat
     */
    'enable'?: boolean;
    /**
