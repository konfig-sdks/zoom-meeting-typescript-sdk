 ...
 * @export
 * @interface MeetingsCreateMeetingRequestRecurrence
 */
export interface MeetingsCreateMeetingRequestRecurrence {
    /**
     ...
     * @type {string}
     * @memberof MeetingsCreateMeetingRequestRecurrence
     */
     ...
     * @memberof MeetingsCreateMeetingRequestRecurrence
     */
    'monthly_week'?: MeetingsCreateMeetingRequestRecurrenceMonthlyWeekEnum;
    /**
     ...
     * @memberof MeetingsCreateMeetingRequestRecurrence
     */
    'monthly_week_day'?: MeetingsCreateMeetingRequestRecurrenceMonthlyWeekDayEnum;
    /**
     ...
     * @memberof MeetingsCreateMeetingRequestRecurrence
     */
    'type': MeetingsCreateMeetingRequestRecurrenceTypeEnum;
    /**
     ...
     * @memberof MeetingsCreateMeetingRequestRecurrence
     */
    'weekly_days'?: MeetingsCreateMeetingRequestRecurrenceWeeklyDaysEnum;
}

type MeetingsCreateMeetingRequestRecurrenceMonthlyWeekEnum = -1 | 1 | 2 | 3 | 4
type MeetingsCreateMeetingRequestRecurrenceMonthlyWeekDayEnum = 1 | 2 | 3 | 4 | 5 | 6 | 7
type MeetingsCreateMeetingRequestRecurrenceTypeEnum = 1 | 2 | 3
type MeetingsCreateMeetingRequestRecurrenceWeeklyDaysEnum = '1' | '2' | '3' | '4' | '5' | '6' | '7'
