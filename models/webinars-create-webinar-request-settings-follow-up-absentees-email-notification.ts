 ...
 * @export
 * @interface WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification
 */
export interface WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification {
    /**
     * * `true` - Send follow-up email to absentees.  * `false` - Do not send follow-up email to absentees.
     * @type {boolean}
     * @memberof WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification
     */
    'enable'?: boolean;
    /**
     ...
     * @memberof WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification
     */
    'type'?: WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotificationTypeEnum;
}

type WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotificationTypeEnum = 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7
