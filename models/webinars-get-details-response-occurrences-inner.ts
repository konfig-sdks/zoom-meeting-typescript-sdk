 ...
 * @export
 * @interface WebinarsGetDetailsResponseOccurrencesInner
 */
export interface WebinarsGetDetailsResponseOccurrencesInner {
    /**
     * Duration.
     * @type {number}
     * @memberof WebinarsGetDetailsResponseOccurrencesInner
     */
    'duration'?: number;
    /**
     ...
     * @memberof WebinarsGetDetailsResponseOccurrencesInner
     */
    'status'?: WebinarsGetDetailsResponseOccurrencesInnerStatusEnum;
}

type WebinarsGetDetailsResponseOccurrencesInnerStatusEnum = 'available' | 'deleted'
