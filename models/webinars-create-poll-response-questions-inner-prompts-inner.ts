 ...
 * 
 * @export
 * @interface WebinarsCreatePollResponseQuestionsInnerPromptsInner
 */
export interface WebinarsCreatePollResponseQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof WebinarsCreatePollResponseQuestionsInnerPromptsInner
     */
