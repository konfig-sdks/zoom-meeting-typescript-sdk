...
import { MeetingsCreatePollRequestQuestionsInnerPromptsInner } from './meetings-create-poll-request-questions-inner-prompts-inner';

/**
 * 
 * @export
 * @interface MeetingsCreatePollRequestQuestionsInner
 */
export interface MeetingsCreatePollRequestQuestionsInner {
    /**
     ...
     * @type {number}
     * @memberof MeetingsCreatePollRequestQuestionsInner
     */
     ...
     * @type {Array<MeetingsCreatePollRequestQuestionsInnerPromptsInner>}
     * @memberof MeetingsCreatePollRequestQuestionsInner
     */
    'prompts'?: Array<MeetingsCreatePollRequestQuestionsInnerPromptsInner>;
    /**
     ...
     * @memberof MeetingsCreatePollRequestQuestionsInner
     */
    'type'?: MeetingsCreatePollRequestQuestionsInnerTypeEnum;
}

type MeetingsCreatePollRequestQuestionsInnerTypeEnum = 'single' | 'multiple' | 'matching' | 'rank_order' | 'short_answer' | 'long_answer' | 'fill_in_the_blank' | 'rating_scale'
