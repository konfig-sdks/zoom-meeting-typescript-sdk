 ...
 * @export
 * @interface MeetingsGetDetailsResponseSettingsApprovedOrDeniedCountriesOrRegions
 */
export interface MeetingsGetDetailsResponseSettingsApprovedOrDeniedCountriesOrRegions {
    /**
     * List of countries/regions from where participants can join this meeting. 
     * @type {Array<string>}
     * @memberof MeetingsGetDetailsResponseSettingsApprovedOrDeniedCountriesOrRegions
     */
     ...
     * @memberof MeetingsGetDetailsResponseSettingsApprovedOrDeniedCountriesOrRegions
     */
    'method'?: MeetingsGetDetailsResponseSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum;
}

type MeetingsGetDetailsResponseSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum = 'approve' | 'deny'
