...
import { MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner } from './meeting-and-webinar-polling-object1-questions-inner-prompts-inner';

/**
 * 
 * @export
 * @interface MeetingAndWebinarPollingObject1QuestionsInner
 */
export interface MeetingAndWebinarPollingObject1QuestionsInner {
    /**
     ...
     * @type {number}
     * @memberof MeetingAndWebinarPollingObject1QuestionsInner
     */
     ...
     * @type {Array<MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner>}
     * @memberof MeetingAndWebinarPollingObject1QuestionsInner
     */
    'prompts'?: Array<MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner>;
    /**
     ...
     * @memberof MeetingAndWebinarPollingObject1QuestionsInner
     */
    'type'?: MeetingAndWebinarPollingObject1QuestionsInnerTypeEnum;
}

type MeetingAndWebinarPollingObject1QuestionsInnerTypeEnum = 'single' | 'multiple' | 'matching' | 'rank_order' | 'short_answer' | 'long_answer' | 'fill_in_the_blank' | 'rating_scale'
