 ...
 * 
 * @export
 * @interface MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner
 */
export interface MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner
     */
