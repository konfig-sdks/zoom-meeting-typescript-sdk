...
import { MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner } from './meetings-create-batch-polls-request-polls-inner-questions-inner-prompts-inner';

/**
 * 
 * @export
 * @interface MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner
 */
export interface MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner {
    /**
     ...
     * @type {number}
     * @memberof MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner
     */
    ...
    /**
     * The poll question\'s title, up to 255 characters.   For `fill_in_the_blank` polls, this field is the poll\'s question. For each value that the user must fill in, ensure that there are the same number of `right_answers` values.
     * @type {string}
     * @memberof MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner
     */
    'name'?: string;
     ...
     * @type {Array<MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner>}
     * @memberof MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner
     */
    'prompts'?: Array<MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner>;
    /**
     ...
     * @memberof MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner
     */
    'type'?: MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerTypeEnum;
}

type MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerTypeEnum = 'single' | 'multiple' | 'matching' | 'rank_order' | 'short_answer' | 'long_answer' | 'fill_in_the_blank' | 'rating_scale'
