...
import { WebinarsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner } from './webinars-update-survey-request-custom-survey-questions-inner-prompts-inner';

/**
 * 
 * @export
 * @interface WebinarsUpdateSurveyRequestCustomSurveyQuestionsInner
 */
export interface WebinarsUpdateSurveyRequestCustomSurveyQuestionsInner {
    /**
     * The survey question, up to 420 characters.
     * @type {string}
     * @memberof WebinarsUpdateSurveyRequestCustomSurveyQuestionsInner
     */
    'name'?: string;
    /**
     ...
     * @memberof WebinarsUpdateSurveyRequestCustomSurveyQuestionsInner
     */
    'type'?: WebinarsUpdateSurveyRequestCustomSurveyQuestionsInnerTypeEnum;
    /**
     ...
     * @type {Array<WebinarsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner>}
     * @memberof WebinarsUpdateSurveyRequestCustomSurveyQuestionsInner
     */
    'prompts'?: Array<WebinarsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner>;
    /**
...
type WebinarsUpdateSurveyRequestCustomSurveyQuestionsInnerTypeEnum = 'single' | 'multiple' | 'matching' | 'rank_order' | 'short_answer' | 'long_answer' | 'fill_in_the_blank' | 'rating_scale'
