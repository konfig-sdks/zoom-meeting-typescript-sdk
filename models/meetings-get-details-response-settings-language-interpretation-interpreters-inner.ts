 ...
 * 
 * @export
 * @interface MeetingsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner
 */
export interface MeetingsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner {
    /**
     * The interpreter\'s email address.
     * @type {string}
     * @memberof MeetingsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner
     */
    'email'?: string;
    /**
