 ...
 * 
 * @export
 * @interface WebinarsUpdatePollRequestQuestionsInnerPromptsInner
 */
export interface WebinarsUpdatePollRequestQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof WebinarsUpdatePollRequestQuestionsInnerPromptsInner
     */
