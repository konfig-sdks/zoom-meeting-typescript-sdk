...
import { WebinarsUpdatePollRequestQuestionsInnerPromptsInner } from './webinars-update-poll-request-questions-inner-prompts-inner';

/**
 * 
 * @export
 * @interface WebinarsUpdatePollRequestQuestionsInner
 */
export interface WebinarsUpdatePollRequestQuestionsInner {
    /**
     ...
     * @type {number}
     * @memberof WebinarsUpdatePollRequestQuestionsInner
     */
     ...
     * @type {Array<WebinarsUpdatePollRequestQuestionsInnerPromptsInner>}
     * @memberof WebinarsUpdatePollRequestQuestionsInner
     */
    'prompts'?: Array<WebinarsUpdatePollRequestQuestionsInnerPromptsInner>;
    /**
     ...
     * @memberof WebinarsUpdatePollRequestQuestionsInner
     */
    'type'?: WebinarsUpdatePollRequestQuestionsInnerTypeEnum;
}

type WebinarsUpdatePollRequestQuestionsInnerTypeEnum = 'single' | 'multiple' | 'matching' | 'rank_order' | 'short_answer' | 'long_answer' | 'fill_in_the_blank' | 'rating_scale'
