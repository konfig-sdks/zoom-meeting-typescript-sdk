 ...
 * 
 * @export
 * @interface MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner
 */
export interface MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner
     */
