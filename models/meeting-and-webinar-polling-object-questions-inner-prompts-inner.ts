 ...
 * 
 * @export
 * @interface MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner
 */
export interface MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner
     */
