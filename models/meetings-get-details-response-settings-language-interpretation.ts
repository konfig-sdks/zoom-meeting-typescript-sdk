...
import { MeetingsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner } from './meetings-get-details-response-settings-language-interpretation-interpreters-inner';
 ...
 * @export
 * @interface MeetingsGetDetailsResponseSettingsLanguageInterpretation
 */
export interface MeetingsGetDetailsResponseSettingsLanguageInterpretation {
    /**
     ...
     * @type {boolean}
     * @memberof MeetingsGetDetailsResponseSettingsLanguageInterpretation
     */
    'enable'?: boolean;
    /**
     * Information about the meeting\'s language interpreters.
     * @type {Array<MeetingsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner>}
     * @memberof MeetingsGetDetailsResponseSettingsLanguageInterpretation
     */
    'interpreters'?: Array<MeetingsGetDetailsResponseSettingsLanguageInterpretationInterpretersInner>;
}
