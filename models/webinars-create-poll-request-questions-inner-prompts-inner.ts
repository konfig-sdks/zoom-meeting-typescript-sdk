 ...
 * 
 * @export
 * @interface WebinarsCreatePollRequestQuestionsInnerPromptsInner
 */
export interface WebinarsCreatePollRequestQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof WebinarsCreatePollRequestQuestionsInnerPromptsInner
     */
