...
import { WebinarsUpdateSurveyRequestCustomSurveyQuestionsInner } from './webinars-update-survey-request-custom-survey-questions-inner';

/**
 * Information about the customized webinar survey.
 * @export
 * @interface WebinarsUpdateSurveyRequestCustomSurvey
 */
export interface WebinarsUpdateSurveyRequestCustomSurvey {
    /**
     * The survey\'s title, up to 64 characters.
     * @type {string}
     * @memberof WebinarsUpdateSurveyRequestCustomSurvey
     */
    'title'?: string;
    /**
     ...
     * @type {Array<WebinarsUpdateSurveyRequestCustomSurveyQuestionsInner>}
     * @memberof WebinarsUpdateSurveyRequestCustomSurvey
     */
    'questions'?: Array<WebinarsUpdateSurveyRequestCustomSurveyQuestionsInner>;
}
