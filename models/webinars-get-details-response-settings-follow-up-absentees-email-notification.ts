 ...
 * @export
 * @interface WebinarsGetDetailsResponseSettingsFollowUpAbsenteesEmailNotification
 */
export interface WebinarsGetDetailsResponseSettingsFollowUpAbsenteesEmailNotification {
    /**
     * * `true` - Send follow-up email to absentees.  * `false` - Do not send follow-up email to absentees.
     * @type {boolean}
     * @memberof WebinarsGetDetailsResponseSettingsFollowUpAbsenteesEmailNotification
     */
    'enable'?: boolean;
    /**
     ...
     * @memberof WebinarsGetDetailsResponseSettingsFollowUpAbsenteesEmailNotification
     */
    'type'?: WebinarsGetDetailsResponseSettingsFollowUpAbsenteesEmailNotificationTypeEnum;
}

type WebinarsGetDetailsResponseSettingsFollowUpAbsenteesEmailNotificationTypeEnum = 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7
