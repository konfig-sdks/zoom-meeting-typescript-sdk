 ...
 * 
 * @export
 * @interface WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner
 */
export interface WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner
     */
