...
import { MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner } from './meetings-update-survey-request-custom-survey-questions-inner-prompts-inner';

/**
 * 
 * @export
 * @interface MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner
 */
export interface MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner {
    /**
     * The survey question, up to 420 characters.
     * @type {string}
     * @memberof MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner
     */
    'name'?: string;
    /**
     ...
     * @memberof MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner
     */
    'type'?: MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerTypeEnum;
    /**
     ...
     * @type {Array<MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner>}
     * @memberof MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner
     */
    'prompts'?: Array<MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner>;
    /**
...
type MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerTypeEnum = 'single' | 'multiple' | 'matching' | 'rank_order' | 'short_answer' | 'long_answer' | 'fill_in_the_blank' | 'rating_scale'
