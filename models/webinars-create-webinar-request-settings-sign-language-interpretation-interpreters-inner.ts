 ...
 * 
 * @export
 * @interface WebinarsCreateWebinarRequestSettingsSignLanguageInterpretationInterpretersInner
 */
export interface WebinarsCreateWebinarRequestSettingsSignLanguageInterpretationInterpretersInner {
    /**
     * The interpreter\'s email address.
     * @type {string}
     * @memberof WebinarsCreateWebinarRequestSettingsSignLanguageInterpretationInterpretersInner
     */
    'email'?: string;
    /**
