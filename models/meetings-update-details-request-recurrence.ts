 ...
 * @export
 * @interface MeetingsUpdateDetailsRequestRecurrence
 */
export interface MeetingsUpdateDetailsRequestRecurrence {
    /**
     ...
     * @type {string}
     * @memberof MeetingsUpdateDetailsRequestRecurrence
     */
     ...
     * @memberof MeetingsUpdateDetailsRequestRecurrence
     */
    'monthly_week'?: MeetingsUpdateDetailsRequestRecurrenceMonthlyWeekEnum;
    /**
     ...
     * @memberof MeetingsUpdateDetailsRequestRecurrence
     */
    'monthly_week_day'?: MeetingsUpdateDetailsRequestRecurrenceMonthlyWeekDayEnum;
    /**
     ...
     * @memberof MeetingsUpdateDetailsRequestRecurrence
     */
    'type': MeetingsUpdateDetailsRequestRecurrenceTypeEnum;
    /**
     ...
     * @memberof MeetingsUpdateDetailsRequestRecurrence
     */
    'weekly_days'?: MeetingsUpdateDetailsRequestRecurrenceWeeklyDaysEnum;
}

type MeetingsUpdateDetailsRequestRecurrenceMonthlyWeekEnum = -1 | 1 | 2 | 3 | 4
type MeetingsUpdateDetailsRequestRecurrenceMonthlyWeekDayEnum = 1 | 2 | 3 | 4 | 5 | 6 | 7
type MeetingsUpdateDetailsRequestRecurrenceTypeEnum = 1 | 2 | 3
type MeetingsUpdateDetailsRequestRecurrenceWeeklyDaysEnum = '1' | '2' | '3' | '4' | '5' | '6' | '7'
