 ...
 * @export
 * @interface MeetingsAddRegistrantResponseOccurrencesInner
 */
export interface MeetingsAddRegistrantResponseOccurrencesInner {
    /**
     * Duration.
     * @type {number}
     * @memberof MeetingsAddRegistrantResponseOccurrencesInner
     */
    'duration'?: number;
    /**
