...
import { WebinarsCreatePollResponseQuestionsInnerPromptsInner } from './webinars-create-poll-response-questions-inner-prompts-inner';

/**
 * 
 * @export
 * @interface WebinarsCreatePollResponseQuestionsInner
 */
export interface WebinarsCreatePollResponseQuestionsInner {
    /**
     ...
     * @type {number}
     * @memberof WebinarsCreatePollResponseQuestionsInner
     */
     ...
     * @type {Array<WebinarsCreatePollResponseQuestionsInnerPromptsInner>}
     * @memberof WebinarsCreatePollResponseQuestionsInner
     */
    'prompts'?: Array<WebinarsCreatePollResponseQuestionsInnerPromptsInner>;
    /**
     ...
     * @memberof WebinarsCreatePollResponseQuestionsInner
     */
    'type'?: WebinarsCreatePollResponseQuestionsInnerTypeEnum;
}

type WebinarsCreatePollResponseQuestionsInnerTypeEnum = 'single' | 'multiple' | 'matching' | 'rank_order' | 'short_answer' | 'long_answer' | 'fill_in_the_blank' | 'rating_scale'
