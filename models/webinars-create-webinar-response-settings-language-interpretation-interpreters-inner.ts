 ...
 * 
 * @export
 * @interface WebinarsCreateWebinarResponseSettingsLanguageInterpretationInterpretersInner
 */
export interface WebinarsCreateWebinarResponseSettingsLanguageInterpretationInterpretersInner {
    /**
     * The interpreter\'s email address.
     * @type {string}
     * @memberof WebinarsCreateWebinarResponseSettingsLanguageInterpretationInterpretersInner
     */
    'email'?: string;
    /**
