 ...
 * 
 * @export
 * @interface MeetingsCreatePollRequestQuestionsInnerPromptsInner
 */
export interface MeetingsCreatePollRequestQuestionsInnerPromptsInner {
    /**
     * The question prompt\'s title.
     * @type {string}
     * @memberof MeetingsCreatePollRequestQuestionsInnerPromptsInner
     */
