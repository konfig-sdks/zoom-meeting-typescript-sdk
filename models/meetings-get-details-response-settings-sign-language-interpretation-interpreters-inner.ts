 ...
 * 
 * @export
 * @interface MeetingsGetDetailsResponseSettingsSignLanguageInterpretationInterpretersInner
 */
export interface MeetingsGetDetailsResponseSettingsSignLanguageInterpretationInterpretersInner {
    /**
     * The interpreter\'s email address.
     * @type {string}
     * @memberof MeetingsGetDetailsResponseSettingsSignLanguageInterpretationInterpretersInner
     */
    'email'?: string;
    /**
