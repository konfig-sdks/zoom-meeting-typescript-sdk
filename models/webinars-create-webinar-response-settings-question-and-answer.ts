 ...
 * @export
 * @interface WebinarsCreateWebinarResponseSettingsQuestionAndAnswer
 */
export interface WebinarsCreateWebinarResponseSettingsQuestionAndAnswer {
    /**
     * * `true`: Allow participants to submit questions.  * `false`: Do not allow submit questions.
     * @type {boolean}
     * @memberof WebinarsCreateWebinarResponseSettingsQuestionAndAnswer
     */
     ...
     * @memberof WebinarsCreateWebinarResponseSettingsQuestionAndAnswer
     */
    'answer_questions'?: WebinarsCreateWebinarResponseSettingsQuestionAndAnswerAnswerQuestionsEnum;
    /**
...
type WebinarsCreateWebinarResponseSettingsQuestionAndAnswerAnswerQuestionsEnum = 'only' | 'all'
