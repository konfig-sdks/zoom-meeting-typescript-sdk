 ...
 * @export
 * @interface WebinarsCreateWebinarResponseOccurrencesInner
 */
export interface WebinarsCreateWebinarResponseOccurrencesInner {
    /**
     * Duration.
     * @type {number}
     * @memberof WebinarsCreateWebinarResponseOccurrencesInner
     */
    'duration'?: number;
    /**
     ...
     * @memberof WebinarsCreateWebinarResponseOccurrencesInner
     */
    'status'?: WebinarsCreateWebinarResponseOccurrencesInnerStatusEnum;
}

type WebinarsCreateWebinarResponseOccurrencesInnerStatusEnum = 'available' | 'deleted'
