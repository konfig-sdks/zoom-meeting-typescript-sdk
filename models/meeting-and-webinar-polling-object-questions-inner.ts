...
import { MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner } from './meeting-and-webinar-polling-object-questions-inner-prompts-inner';

/**
 * 
 * @export
 * @interface MeetingAndWebinarPollingObjectQuestionsInner
 */
export interface MeetingAndWebinarPollingObjectQuestionsInner {
    /**
     ...
     * @type {number}
     * @memberof MeetingAndWebinarPollingObjectQuestionsInner
     */
     ...
     * @type {Array<MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner>}
     * @memberof MeetingAndWebinarPollingObjectQuestionsInner
     */
    'prompts'?: Array<MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner>;
    /**
     ...
     * @memberof MeetingAndWebinarPollingObjectQuestionsInner
     */
    'type'?: MeetingAndWebinarPollingObjectQuestionsInnerTypeEnum;
}

type MeetingAndWebinarPollingObjectQuestionsInnerTypeEnum = 'single' | 'multiple' | 'matching' | 'rank_order' | 'short_answer' | 'long_answer' | 'fill_in_the_blank' | 'rating_scale'
